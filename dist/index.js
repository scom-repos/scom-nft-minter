    ...
    let ScomNftMinter = class ScomNftMinter extends components_6.Module {
        ...
        async _createProduct(productMarketplaceAddress, quantity, price, uri, token, callback, confirmationCallback) {
            ...
            if (this._data.paymentModel === index_12.PaymentModel.Subscription) {
                result = await (0, API_2.createSubscriptionNFT)(productMarketplaceAddress, quantity, price, token?.address || index_13.nullAddress, token?.decimals || 18, uri, this._data.durationInDays * 86400 || 0, callback, confirmationCallback);
                this._data.nftType = 'ERC721';
            }
            else {
                result = await (0, API_2.newDefaultBuyProduct)(productMarketplaceAddress, quantity, price, token?.address || index_13.nullAddress, token?.decimals || 18, uri, callback, confirmationCallback);
                this._data.nftType = 'ERC1155';
            ...
            setTimeout(async () => {
                ...
                if (this.productInfo) {
                    ...
                    if (this._type === index_12.ProductType.Buy) {
                        ...
                        this.pnlMintFee.visible = true;
                        this.lblMintFee.caption = `${price ? (0, index_13.formatNumber)(price) : ""} ${token?.symbol || ""}`;
                        this.lblTitle.caption = this._data.title;
                    ...
                    this.pnlAddress.visible = this._type !== index_12.ProductType.Buy;
